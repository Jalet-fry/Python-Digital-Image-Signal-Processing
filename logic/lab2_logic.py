...
class FilterProcessor:
    ...
    def prepare(self):
        """Предварительный расчет всех фильтров."""
        ...
        def calc_snr(clean, processed, delay=0):
            ...
            return 10 * np.log10(np.sum(c**2) / (np.sum((p - c)**2) + 1e-12))
        ...
        self.results = {
            'x_clean': x_clean, 'x_noisy': x_noisy, 'noise': total_noise,
            'y_ma': y_ma, 'y_fir': y_fir, 'y_iir': y_iir,
